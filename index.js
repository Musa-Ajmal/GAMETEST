...
class Moves{
 ...
 class ElementalTypes{
  ...
  charimage.src="Charizard.jpg"
  let galladeimage=new Image()
  galladeimage.src="gallade.jpg"
  let pikachuimage=new Image()
  pikachuimage.src="pikachu.png"
  let articunoimage=new Image()
  articunoimage.src="Articuno.jpg"
  let nidokingimage=new Image()
  nidokingimage.src="nidoking.jpg"
  let Barraskewdaimage=new Image()
  Barraskewdaimage.src="barraskewda.png"
  let clefableimage=new Image()
    clefableimage.src="clefable.png"
    let zygardeimage=new Image()
    zygardeimage.src="zygarde.jpg"
    let gengarimage=new Image()
    gengarimage.src="gengar.png"
    let lucarioimage=new Image()
    lucarioimage.src="lucario.png"
    let moltresimage=new Image()
    moltresimage.src="moltres.png"
    let miraidonimage=new Image()
    miraidonimage.src="miraidon.jpg"
